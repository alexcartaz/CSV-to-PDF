...
await $$`node -e require("fs").copyFileSync(process.execPath,"CSVtoPDF.exe")`;
await $$`npx postject CSVtoPDF.exe NODE_SEA_BLOB main-sea-prep.blob --sentinel-fuse NODE_SEA_FUSE_fce680ab2cc467b6e072b8b5df1996b2`;
