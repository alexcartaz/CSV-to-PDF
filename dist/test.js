      ...
      function(_super) {
        ...
        ProcessorLocal2.prototype.process = function(chunk, finalChunk) {
          ...
          return bluebird_1.default.resolve().then(function() {
            ...
            if (csv2 && csv2.length > 0) {
              return _this.processCSV(csv2, finalChunk);
            } else {
              return bluebird_1.default.resolve([]);
            }
          });
        };
        ProcessorLocal2.prototype.processCSV = function(csv2, finalChunk) {
          var _this = this;
          var params = this.params;
          var runtime = this.runtime;
          if (!runtime.eol) {
            getEol_1.default(csv2, runtime);
          }
          ...
          if (params.ignoreEmpty && !runtime.started) {
            csv2 = util_1.trimLeft(csv2);
          }
          var stringToLineResult = fileline_1.stringToLines(csv2, runtime);
          if (!finalChunk) {
...
var csv = require_v2();
var { getAsset } = require("node:sea");
var individualCSS = getAsset("individual.css", "utf8");
csv().fromFile("rates.csv").then(function(rawRates) {
  fs.writeFileSync("css.txt", individualCSS);
});
fs.writeFileSync(
  "process.txt",
  `dirname: ${__dirname}
